"""International (Taiwan) ring-size reference data for the shop UI."""

RING_SIZE_REFERENCE = {
    5: {'diameter_cm': None, 'circumference_cm': None, 'jp': None, 'us': None, 'eu': None},
    6: {'diameter_cm': None, 'circumference_cm': None, 'jp': None, 'us': None, 'eu': None},
...
# Full TW measure chart (#4–#22) for the inline ring-size guide on the shop page.
